<?php /*a:4:{s:76:"D:\download\ukcms\application\home\view\defaults\column\content\content.html";i:1553153629;s:60:"D:\download\ukcms\application\home\view\defaults\layout.html";i:1553153629;s:61:"D:\download\ukcms\application\home\view\defaults\comment.html";i:1553153629;s:59:"D:\download\ukcms\application\home\view\defaults\right.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <!-- Standard Meta -->
                    ...
                    <div class="right menu">
                        <div class="ui dropdown item "><i class="angle double   down icon"></i>
                            <div class="menu" id="midSelect">
                                ...
                                <?php $sql_list=model('ModelField')->getDataList("model", "purpose='column' and status='1' and create_time <1553155015", "id,title", "", "orders,id desc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
...
<div class="ui bottom attached tab segment" data-tab="second">
    <div class="ui comments">
        <?php $sql_list=model('ModelField')->getDataList("comment", "mid='".$info['model_id']."' and did='".$data['id']."' and status='1' and create_time <1553155015", "id,commenter,message,create_time", "", "orders,id desc", "", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="comment">
            <div class="content">
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("photo", "status='1' and create_time <1553155015", "id,cname,title,cover", "", "orders,id desc", "2", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1553155015", "id,cname,title,description,create_time", "", "hits desc", "4", null, 0, "1");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
...
<div class="ui segment">
    ...
    <div class="ui divided list articleList">
        <?php $sql_list=model('ModelField')->getDataList("article", "status='1' and create_time <1553155015", "id,cname,title,description,create_time", "", "[rand]", "4", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="item">
            <span class="right floated"><?php echo date('Y-m-d',$vo['create_time']); ?></span>
            <a href="<?php echo htmlentities($vo['url']); ?>"><i class="file outline icon"></i><?php echo htmlentities($vo['title']); ?></a>
        </div>
...
<div class="ui segment">
    ...
    <div class="ui two column grid ">
        <?php $sql_list=model('ModelField')->getDataList("product", "status='1' and create_time <1553155015", "id,cname,title,cover", "", "create_time desc", "2", null, 0, "");  $sum=count($sql_list);  foreach($sql_list as $key=>$vo): ?>
        <div class="column">
            <div class="ui fluid image">
                <a href="<?php echo htmlentities($vo['url']); ?>" class="ui medium rounded  image" >
                    <img  src="/public/uploads/<?php echo htmlentities($vo['cover']['thumb']); ?>" alt="<?php echo htmlentities($vo['title']); ?>">
