<?php /*a:2:{s:58:"D:\download\ukcms\application\admin\view\column\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th width="50">ID</th><th>栏目名称</th><th>英文标识</th><th>栏目类型</th><th>内容模型/地址</th><th width="118">内容管理</th><th width="80">排序</th><th width="60">状态</th><th width="90">操作</th>
                    </tr>
                    <?php if(is_array($clist) || $clist instanceof \think\Collection || $clist instanceof \think\Paginator): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php if(isset($vo['mtitle'])): ?><?php echo htmlentities($vo['mtitle']); else: ?><?php echo htmlentities($vo['url']); ?><?php endif; ?></td>
                        <td>
                            <?php if($vo['type']==2): ?>
