<?php /*a:2:{s:55:"D:\download\ukcms\application\admin\view\app\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr id="<?php echo htmlentities($key); ?>">
                    <td><?php echo htmlentities($key); ?></td>
                    <td><a href="<?php echo url($key.'/index/index'); ?>" target="_blank" data-toggle="tooltip" data-placement="top"  data-original-title="点击预览"><?php echo htmlentities($vo['title']); ?></a></td>
                    ...
                    <td>
                        <?php if($vo['installstate']): if($vo['status']): ?> 
                    ...
                    <td><?php if($vo['installstate']): ?> <button data-url="<?php echo url('uninstall',['app'=>$key]); ?>"  class=" btn  btn-sm btn-warning uninstall" >卸载</button><?php else: ?><button data-url="<?php echo url('install',['app'=>$key]); ?>" class="btn btn-sm btn-success install" >安装</button> <?php endif; ?></td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </table>
        </div>
