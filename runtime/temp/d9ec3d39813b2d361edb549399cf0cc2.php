<?php /*a:2:{s:58:"D:\download\ukcms\application\admin\view\content\list.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <tr>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; if(!empty($places)): ?><th width="70"><div id="locat" class="btn btn-sm btn-default" data-state="0">推荐位</div></th><?php endif; ?><th>发布人</th><th width="60">点击量</th><th width="160">更新时间</th><th width="50">排序</th><th width="60">状态</th><th width="100">操作</th>
                    </tr>
                    ...
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><a href="<?php if($columnList[$vo['cname']]['type']==2): ?><?php echo appUrl('index',$vo['cname'].'/'.$vo['id']); else: ?><?php echo appUrl('index',$vo['cname']); ?><?php endif; ?>"
                               target="_blank" ><?php echo htmlspecialchars_decode($vo[$v['name']]); ?></a></td>
                        <?php else: ?>
                        ...
                        <td align="center" class="font-size-16">
                            <?php $vo['places']=substr($vo['places'],1); if(''!=$vo['places']): $nowPlaceArr=explode(',',$vo['places']);$vo['places']=''; foreach($nowPlaceArr as $p): if($p): $vo['places'].=' '.$places[$p]; ?><?php endif; ?>
                            <?php endforeach; ?>
                        ...
                        <td><a href="<?php echo url('edit',['cname'=>$columnName,'id'=>$vo['id']]); ?>"><i  class="fa fa-edit btn  btn-sm btn-primary" data-toggle="tooltip" data-placement="top"  data-original-title="编辑"></i></a> <i  class="fa fa-times btn  btn-sm btn-warning del" data-toggle="tooltip" data-placement="top"  data-original-title="删除"></i></td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <tr>
                        <td colspan="11">
