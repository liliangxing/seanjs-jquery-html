<?php /*a:2:{s:58:"D:\download\ukcms\application\admin\view\behavior\add.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel">
    <div class="panel-heading">
        <div class="panel-title">添加行为</div>
    </div>
    <form class="panel-body" method="post" action="">
        <fieldset class="form-group">
            <label>行为类名*</label>
            <input type="text" class="form-control" name="name" placeholder="行为类名" value="">
             <small class="text-muted">带命名空间完整行为路径</small>
        </fieldset>
        <fieldset class="form-group">
            <label>排序</label>
