<?php /*a:2:{s:56:"D:\download\ukcms\application\admin\view\user\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel">
    <div class="panel-heading">
        ...
        <div class="panel-heading-controls"> 
            <a class="btn btn-xs btn-primary" href="<?php echo url('add'); ?>"><i class="fa fa-user-plus"></i> 新增用户</a>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <tr>
                        ...
                        <th>用户名</th><th>姓名</th><th>角色</th><th width="80">状态</th><th width="160">创建时间</th><th width="100">操作</th>
                    </tr>
                    ...
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php echo htmlentities($glist[$vo['groupid']]); ?></td>
                        <td>
                            <?php if($vo['status']): ?> 
...
<div class="alert alert-default">
    ...
    只可管理当前登录用户所属角色的下级角色下的用户，不可管理同级角色下的用户
</div>
...
<script>
    ...
    $(function () {
        ...
        $('.status').click(function () {
            ...
            $.ajax({
                url: "<?php echo url('user/setstate'); ?>",
                type: "GET",
                data: {
                    id: id,
                    status: status
