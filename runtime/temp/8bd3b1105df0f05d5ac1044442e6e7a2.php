<?php /*a:2:{s:57:"D:\download\ukcms\application\admin\view\column\edit.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <fieldset class="form-group linkcolumn">
                        <label>栏目链接地址*</label>
                        <input type="text" class="form-control" name="url" placeholder="自定义栏目跳转地址" value="<?php if(3==$info['type']): ?><?php echo htmlentities($info['url']); ?><?php endif; ?>">
