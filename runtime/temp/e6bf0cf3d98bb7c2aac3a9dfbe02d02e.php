<?php /*a:2:{s:56:"D:\download\ukcms\application\admin\view\hook\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel">
    <div class="panel-heading">
        ...
        <div class="panel-heading-controls"> 
            <a class="btn btn-xs btn-primary" href="<?php echo url('add'); ?>"><i class="fa fa-plus"></i> 新增钩子</a>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php if($vo['ifsystem']): ?>系统<?php else: ?>自定义<?php endif; ?></td>
                        ...
                        <td><a class="btn  btn-sm btn-primary" href="<?php echo url('edit',['id'=>$vo['id']]); ?>">设置</a> <?php if(!$vo['ifsystem']): ?><button class="btn  btn-sm btn-warning del">删除</button><?php endif; ?></td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; if($page): ?>
                    <tr>
                        <td colspan="8">
                            <?php echo $page; ?>
                        </td>
