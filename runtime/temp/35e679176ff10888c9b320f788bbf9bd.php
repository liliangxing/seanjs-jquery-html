<?php /*a:2:{s:57:"D:\download\ukcms\application\admin\view\model\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-primary" href="<?php echo url('chartdata',['mid'=>$vo['id']]); ?>" data-toggle="tooltip" data-placement="top" data-original-title="模型数据图表"><i class="fa fa-bar-chart"></i></a>
                        </td>
                        <td>
                            <?php if($vo['ifsub']): ?>
