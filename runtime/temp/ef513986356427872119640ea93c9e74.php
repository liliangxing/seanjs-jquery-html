<?php /*a:2:{s:55:"D:\download\ukcms\application\admin\view\tag\index.html";i:1553153629;s:52:"D:\download\ukcms\application\admin\view\layout.html";i:1553153629;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel">
    <div class="panel-heading">
        ...
        <div class="panel-heading-controls"> 
            <a class="btn btn-xs btn-primary" href="<?php echo url('add'); ?>"><i class="fa fa-plus"></i> 新增TAG</a>
            <a class="btn btn-xs btn-primary" href="<?php echo url('importdata'); ?>"><i class="fa fa-plus-circle"></i> 导入TAG</a>
        </div>
    </div>
        ...
        <form class="form-inline m-b-2 text-right" method="get">
            <div class="form-group">
                ...
                <select class="custom-select form-control" name="mid">
                    ...
                    <option value="<?php echo htmlentities($key); ?>" <?php if($key==app('request')->get('mid')): ?>selected<?php endif; ?>><?php echo htmlentities($vo); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php if($vo['mid']): ?><?php echo htmlentities($mlist[$vo['mid']]); else: ?>[所有]<?php endif; ?></td>
                        <td><?php echo $vo['url']; ?></td>
                        <td><table class="editable-table" width="100%" height="100%"><tr><td><?php echo htmlentities($vo['weight']); ?></td></tr></table></td>
